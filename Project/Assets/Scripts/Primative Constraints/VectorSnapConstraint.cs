...
// [ExecuteInEditMode]
public class VectorSnapConstraint : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        _gridManager = _vectorManager.gridManager;
    }
    ...
    private void Update()
    {
        ...
        _vectorManager.SetNewValue(new Vector3(closestCoordX, closestCoordY, 0));
    }
